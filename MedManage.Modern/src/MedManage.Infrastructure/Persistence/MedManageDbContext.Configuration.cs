...
public partial class MedManageDbContext
{
    partial void OnModelCreatingPartial(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TariffPercentage>(entity =>
        {
            entity.HasKey(e => e.TariffPercentageId);
            entity.Property(e => e.TariffPercentageId).ValueGeneratedOnAdd();
            entity.Property(e => e.PercentageAdded).HasColumnType("decimal(10, 4)");
            entity.Property(e => e.Status).HasMaxLength(50);
            entity.Property(e => e.Notes).HasMaxLength(500);

            // Index for propagation query performance (finding records by period and end date)
            entity.HasIndex(e => new { e.TariffPeriodName, e.EndActiveDate })
                .HasDatabaseName("IX_TariffPercentage_TariffPeriodName_EndActiveDate");

            // Index for overlap detection (finding records by period and start date)
            entity.HasIndex(e => new { e.TariffPeriodName, e.StartActiveDate })
