...
namespace Icondev.MedManage
{
    public partial class rpt_Cases_BetweenDates : Form
    {
        ...
        private void rpt_Cases_BetweenDates_Load(object sender, EventArgs e)
        {
            ...
            this.usp_rpt_Cases_Select_Filters_BetweenDatesTableAdapter.Fill(this.ReportsDataSet.usp_rpt_Cases_Select_Filters_BetweenDates
                ,txtCaseNumber.Text
