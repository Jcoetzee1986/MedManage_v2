...
namespace Icondev.MedManage
{
    public partial class rpt_Cases_BetweenDates_Primary : Form
    {
        ...
        private void rpt_Cases_BetweenDates_Load(object sender, EventArgs e)
        {
            ...
            // INFO: This line of code loads data into the 'ReportsDataSet.usp_rpt_Cases_Select_Filters_ParentCase' table. You can move, or remove it, as needed.
            //this.usp_rpt_Cases_Select_Filters_ParentCaseTableAdapter.Fill(this.ReportsDataSet.usp_rpt_Cases_Select_Filters_ParentCase
            //    ,txtCaseNumber.Text
