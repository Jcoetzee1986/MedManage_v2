...
{
    public partial class rpt_CaseCommentExport : Form
    {
        int CaseID;
        public rpt_CaseCommentExport(int caseID)
        {
            InitializeComponent();
            CaseID = caseID;
        }
        ...
        private void rpt_CaseCommentExport_Load(object sender, EventArgs e)
        {
            ...
            this.usp_CaseComment_SelectTableAdapter.Fill(this.ReportsDataSet.usp_CaseComment_Select, CaseID);
